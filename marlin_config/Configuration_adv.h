...
// Rob Mendon / 3D Printing Candada uses 60 here
// Marlin example config 020006 uses 40 here
// I'm not sure it matters that much - HVC
   ...
   * below 2.
   */
// Rob Mendon / 3D Printing Candada uses 40 here
// Marlin example config 020006 uses 20
// I'm not sure it matters that much - HVC
...
// Rob Mendon / 3D Printing Candada uses 100 here
// Marlin example config 020006 uses 20 here
// I'm not sure which is correct - HVC
   ...
   */
  // Increased from 60 to 100 to prevent false positives. - HVC
...
// I don't think this was the problem, so re-enabling it. - HVC
 ...
 */
// Rob Mendon / 3D Printing Candada uses this feature
// Marlin example config 020006 disables this feature
// CR-20 Pro doesn't have a case light - HVC
...
// Rob Mendon / 3D Printing Candada uses this feature
// Marlin example config 020006 disables this feature
// I'm not sure which is correct, but enabling can't hurt? - HVC
 ...
 */
// Rob Mendon / 3D Printing Candada uses { 1200, 1200, 1000 }
// Marlin example config 020006 is commented out
// 020006 also is missing the MOTOR_CURRENT_PWM_RANGE setting 
// so I'm just going to leave this commented out for now... - HVC
...
// Rob Mendon / 3D Printing Candada uses "inverted"
// Marlin example config 020006 is commented out
// I'm not sure which is correct - HVC
// Leaving it commented out works fine - HVC
  ...
  // Disabled - homing/abl gives us plenty of time to abort print
...
// Rob Mendon / 3D Printing Candada uses this feature
// Marlin example config 020006 disables this feature
// It's an advertised feature of the CR-20 Pro... - HVC
// Disabling to save SRAM - HVC
//#define POWER_LOSS_RECOVERY
  ...
  // SD Card Sorting options
    ...
    // Changed from -1 to 1, personal preference - HVC
   ...
   */
  // Enabling this causes a compilation error - HVC
...
// Rob Mendon / 3D Printing Candada defines this
// Marlin example config 020006 comments this out
// I don't know what it does... - HVC
...
// Enabled for not adding in my head - HVC
 ...
 */
#define LIN_ADVANCE // Enabled for QUALITY - HVC
#if ENABLED(LIN_ADVANCE)
  //#define EXTRA_LIN_ADVANCE_K // Enable for second linear advance constants
  // No clue what this should be set to - HVC
  // PLA with a 0.4mm nozzle came out to 1.1 via the test script - HVC
...
// enabled for extra display stuff - HVC
// disabled again to save SRAM - HVC
